...
class GameApp {
    ...
    loadGame(gameName) {
        ...
        switch(gameName) {
            case 'memory':
                ...
                // Kall init funksjonen etter at området er synlig
                setTimeout(() => {
    ...
    // Bakgrunnsanimasjoner (samme som før)
    createStars() {
    ...
    createPlanets() {
        ...
        for (let i = 0; i < planetCount; i++) {
            ...
            planet.style.background = `radial-gradient(circle at 30% 30%, ${color}, ${color}dd)`;
    ...
    createMeteor() {
        ...
        meteor.style.transform = `rotate(${angle + 310}deg)`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Sett opp globale funksjoner for spill - FJERN placeholder-funksjonene
    // Disse blir satt opp automatisk når script-filene lastes
});

// FJERN placeholder funksjonene - de forhindrer at de ekte funksjonene kjøres
// La de ekte funksjonene i de respektive .js filene håndtere spillene